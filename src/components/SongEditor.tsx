  ...
  return (
    <div className="song-editor">
      ...
      <div className="se-actions">
        {onDelete && (
          <button className="se-delete" onClick={onDelete}>
            <TrashIcon size={16} /> Delete song
          </button>
        )}
        <div className="se-actions-right">
          <button className="se-btn" onClick={onCancel}>
            Cancel
          </button>
...
/** The editor in a dialog, which is how everything opens it. */
export function SongEditorModal({ isOpen, onCancel, ...rest }: ModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onCancel} label="Song chart editor" wide>
      <SongEditor onCancel={onCancel} {...rest} />
    </Modal>
  );
}
